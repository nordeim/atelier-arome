    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center bg-parchment py-20 px-4 overflow-hidden" id="hero">
        ...
        <div className="max-w-7xl mx-auto w-full">
          ...
          <div className="relative z-20">
            <div className="text-center mb-12">
              ...
              <div className="mb-12">
                ...
                <p className="font-body text-sm text-gold text-center">
                  &mdash; Master Perfumer&apos;s Journal
                </p>
              </div>
          ...
          {/* Compendium Section - Botanical Compendium */}
          <section className="py-20 px-4 bg-parchment" id="compounds">
            <div className="max-w-7xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row justify-between items-center gap-8 mb-12">
                <div className="flex flex-col gap-2">
                  ...
                  <div className="compendium__filter-buttons flex flex-wrap gap-2">
                    <button className="compendium__filter px-4 py-2 bg-parchment border-2 border-parchment-dark/20 rounded-sm text-ink hover:bg-gold/10 transition-colors">
                      <span className="compendium__filter-text">All Essences</span>
                      <span className="compendium__filter-ornament">✦</span>
                    </button>
                    <button className="compendium__filter px-4 py-2 bg-parchment border-2 border-parchment-dark/20 rounded-sm text-ink hover:bg-gold/10 transition-colors">
                      <span className="compendium__filter-text">Calming</span>
                      <span className="compendium__filter-icon">☾</span>
                    </button>
                    <button className="compendium__filter px-4 py-2 bg-parchment border-2 border-parchment-dark/20 rounded-sm text-ink hover:bg-gold/10 transition-colors">
                      <span className="compendium__filter-text">Uplifting</span>
                      <span className="compendium__filter-icon">☀</span>
                    </button>
                    <button className="compendium__filter px-4 py-2 bg-parchment border-2 border-parchment-dark/20 rounded-sm text-ink hover:bg-gold/10 transition-colors">
                      <span className="compendium__filter-text">Grounding</span>
                      <span className="compendium__filter-icon">♁</span>
                    </button>
                    <button className="compendium__filter px-4 py-2 bg-parchment border-2 border-parchment-dark/20 rounded-sm text-ink hover:bg-gold/10 transition-colors">
                      <span className="compendium__filter-text">Clarifying</span>
                      <span className="compendium__filter-icon">☁</span>
                    </button>
                  </div>
                </div>
                ...
                <div className="relative">
                  <select className="compendium__sort-select px-4 py-2 bg-parchment border-2 border-parchment-dark/20 rounded-sm text-ink appearance-none cursor-pointer" aria-label="Sort compendium">
                    <option value="folio">Folio Order</option>
                    <option value="humour">By Humour</option>
                    <option value="rarity">By Rarity</option>
                    <option value="season">By Season</option>
                  </select>
                  <div className="absolute top-1/2 right-10 w-6 h-6 bg-gold opacity-0"></div>
                </div>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {products.map((product) => (
                <article
                  key={product.id}
                  className={"bg-parchment rounded-sm p-8 relative " + (product.featured ? "ring-2 ring-gold" : "")}
                >
                  <div>
                    {product.featured && (
        ...
        {/* Process Section - The Art of Alchemical Transformation */}
              ...
              <div className="bg-parchment-dark rounded-sm p-8">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="text-text-ink">Hand-bottling</span>
                    <div className="flex justify-between">
